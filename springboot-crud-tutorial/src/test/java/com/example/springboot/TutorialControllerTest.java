...
import com.example.springboot.controller.TutorialController;
...
public class TutorialControllerTest {
    ...
    void shouldCreateTutorial() throws Exception {
        Tutorial tutorial = new Tutorial(1, "Spring Boot @WebMvcTest 1", "Description 1", true);
    ...
    void shouldReturnListOfTutorialsWithFilter() throws Exception {
        ...
        when(tutorialRepository.findByTitleContaining(title, Pageable.unpaged())).thenReturn((Page<Tutorial>) tutorials);
