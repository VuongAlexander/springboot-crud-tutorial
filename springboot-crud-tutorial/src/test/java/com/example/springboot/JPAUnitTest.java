...
public class JPAUnitTest {
    ...
    public void should_find_published_tutorials() {
        ...
        Iterable<Tutorial> tutorials = repository.findByPublished(true, Pageable.unpaged());
    ...
    public void should_find_tutorials_by_title_containing_string() {
        ...
        Iterable<Tutorial> tutorials = repository.findByTitleContaining("ring", Pageable.unpaged());
